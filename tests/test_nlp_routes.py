...
def test_handle_query_forecast(client, owner_headers):
    with patch('app.nlp.routes.resolve_intent', return_value='forecast'), \
...
def test_handle_query_inventory(client, owner_headers):
    with patch('app.nlp.routes.resolve_intent', return_value='inventory'), \
         patch('app.db.session.execute') as mock_execute:
...
def test_handle_query_revenue(client, owner_headers):
    with patch('app.nlp.routes.resolve_intent', return_value='revenue'), \
         patch('app.db.session.execute') as mock_execute:
...
def test_handle_query_profit(client, owner_headers):
    with patch('app.nlp.routes.resolve_intent', return_value='profit'), \
         patch('app.db.session.execute') as mock_execute:
...
def test_handle_query_top_products(client, owner_headers):
    with patch('app.nlp.routes.resolve_intent', return_value='top_products'), \
         patch('app.db.session.execute') as mock_execute:
...
def test_handle_query_loyalty_summary(client, owner_headers):
    with patch('app.nlp.routes.resolve_intent', return_value='loyalty_summary'), \
         patch('app.db.session.execute') as mock_execute:
...
def test_handle_query_credit_overdue(client, owner_headers):
    with patch('app.nlp.routes.resolve_intent', return_value='credit_overdue'), \
         patch('app.db.session.execute') as mock_execute:
...
def test_handle_query_market_intelligence(client, owner_headers):
    with patch('app.nlp.routes.resolve_intent', return_value='market_intelligence'), \
